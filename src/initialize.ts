...
import { cssVariableReferenceStats, currentStylesCollection, currentVariableLibrary, generateCssFromStyles, invertStyles, StylesCollection, StyleSheetCSSArray, updateStyles } from './lib/styles';
