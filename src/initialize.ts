...
import { cssVariableReferenceMap, cssVariableReferenceStats, currentStylesCollection, generateCssFromStyles, invertStyles, StylesCollection, StyleSheetCSSArray, updateStyles } from './lib/styles';
...
export async function initialize() {
  ...
  // Invert styles
  const invertedStyles = invertStyles(currentStylesCollection, cssVariableReferenceStats, cssVariableReferenceMap) as StylesCollection;
